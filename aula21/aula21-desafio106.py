...
# Estou fazendo uma LISTA com as cores, cada cor corresponde a um numero de 0 ate 6
c = ('\033[m',          # 0 - sem cores
...
def ajuda(com):
    titulo(f'Acessando o manual do comando \'{com}\'', 4) # Chamando uma funcão dentro de outra Funcão
    print(c[6], end='')
    help(com)
    print(c[0], end='')
    sleep(2)
